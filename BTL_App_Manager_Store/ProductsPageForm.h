...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->btnRefresh->Click += gcnew System::EventHandler(this, &ProductsPageForm::btnRefresh_Click);
            // 
            // btnSearch
            // 
            ...
            this->btnSearch->Click += gcnew System::EventHandler(this, &ProductsPageForm::btnSearch_Click);
            // 
            // tbxSearch
            // 
...
// ############## Từ Đây Trở Xuống Sẽ Là Nơi Chúng Ta Viết Code #################
    ...
    private:
        ...
        void loadAllDataToTable() {
            ...
            while (res->next()) {
                ...
                if (res->getInt("quantity") <= 5) {
                    this->dataTable->Rows[lastIndex]->DefaultCellStyle->BackColor = Color::FromArgb(255, 26, 26);
                    this->dataTable->Rows[lastIndex]->DefaultCellStyle->ForeColor = Color::White;
                }
    ...
    private: 
        ...
        System::Void btnTrash_Click(System::Object^ sender, System::EventArgs^ e) {
            BTLAppManagerStore::TrashProductsForm^ TrashProductsForm = gcnew BTLAppManagerStore::TrashProductsForm();
