...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tableLayoutPanel2->Size = System::Drawing::Size(1015, 654);
			...
			this->dataTable->Size = System::Drawing::Size(1009, 570);
			...
			this->tableLayoutPanel4->Size = System::Drawing::Size(1009, 76);
			...
			this->btnRefresh->Margin = System::Windows::Forms::Padding(12, 12, 12, 12);
			...
			this->btnSearch->Margin = System::Windows::Forms::Padding(12, 12, 12, 12);
			...
			this->tableLayoutPanel3->Location = System::Drawing::Point(1024, 2);
			this->tableLayoutPanel3->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->tableLayoutPanel3->Name = L"tableLayoutPanel3";
			this->tableLayoutPanel3->RowCount = 1;
			this->tableLayoutPanel3->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 50)));
			this->tableLayoutPanel3->Size = System::Drawing::Size(194, 654);
			...
			this->tableLayoutPanel5->Size = System::Drawing::Size(188, 574);
			...
			this->btnTrash->Location = System::Drawing::Point(30, 469);
			...
			this->btnAdd->Size = System::Drawing::Size(128, 63);
			...
			this->btnEdit->Location = System::Drawing::Point(30, 183);
			this->btnEdit->Margin = System::Windows::Forms::Padding(30, 40, 30, 40);
			this->btnEdit->Name = L"btnEdit";
			this->btnEdit->Size = System::Drawing::Size(128, 63);
			...
			this->btnDelete->Location = System::Drawing::Point(30, 326);
			this->btnDelete->Margin = System::Windows::Forms::Padding(30, 40, 30, 40);
			this->btnDelete->Name = L"btnDelete";
			this->btnDelete->Size = System::Drawing::Size(128, 63);
			...
			this->tableLayoutPanel1->Size = System::Drawing::Size(1221, 658);
			...
			this->ClientSize = System::Drawing::Size(1221, 658);
...
// ############## Từ Đây Trở Xuống Sẽ Là Nơi Chúng Ta Viết Code #################
	...
	private:
		...
		std::string getSearchColumnName() {
			...
			else if (this->cbSearch->SelectedItem->ToString() == "Title") return "title";
		}
		// Load tất cả data trong Database ra Table
		void loadAllDataToTable() {
			this->dataTable->Rows->Clear(); // Xóa dữ liệu cũ trong dataTable
			std::string query = "SELECT * FROM `tb_prods_categories` WHERE (`isDelete` = 0) ORDER BY `id` DESC";
		...
		void loadSearchDataToTable(std::string searchKey) {
			this->dataTable->Rows->Clear(); // Xóa dữ liệu cũ trong dataTable
			std::string query = "SELECT * FROM `tb_prods_categories` WHERE (`isDelete` = 0) AND (`" + getSearchColumnName() + "` LIKE '%" + searchKey + "%') ORDER BY `id` DESC";
			sql::ResultSet* res = APP_SESSION::MyDB->ReadQuery(query);
			while (res->next())
				this->dataTable->Rows->Add(
					res->getInt("id"),
	...
	private: 
		...
		System::Void CategoriesPageForm_Load(System::Object^ sender, System::EventArgs^ e) {
			...
			this->categoryObject = new MyObjects::Category(APP_SESSION::MyDB); // Khởi tạo giá trị cho biến object của Category
		}
		...
		System::Void btnTrash_Click(System::Object^ sender, System::EventArgs^ e) {
			BTLAppManagerStore::TrashCategoriesForm^ TrashCategoriesForm = gcnew BTLAppManagerStore::TrashCategoriesForm(); // tạo form TrashCategoriesForm
